...
const TEMPLATES = [
  ...
  },
  {
    ...
    subtitle: "8 days · Back · Arms · Legs · Chest · ↻",
    tag: "High Volume",
    tagColor: "#FF453A",
    description: "Sam Sulek's Plan A rotating split. Train every day, rest only when genuinely needed. 30 min LISS cardio each morning; push all finishers to failure.",
    weeks: 5,
    sessions: [
      { day: 1, name: "Day 1 — Back & Rear Delts", muscleGroups: ["back", "shoulders"], exercises: ["Shoulder-width Grip Front Pull-down", "Wider Hammer Grip Pull-down", "Machine Low Row", "Machine Lat Pullover", "Seated Low Cable Row", "Lying Face Pull"] },
      { day: 2, name: "Day 2 — Biceps & Triceps", muscleGroups: ["biceps", "triceps"], exercises: ["Cross Cable Triceps Extension", "Machine Dips", "Triceps Press Downs", "Alternating Dumbbell Curls", "Seated Machine Biceps Curls", "Standard Barbell Curl", "Alternating DB Curls (finisher)"] },
      { day: 3, name: "Day 3 — Hamstrings & Quads", muscleGroups: ["hamstrings", "quads"], exercises: ["Lying Leg Curl", "Unilateral Leg Extension", "Bilateral Leg Extension (finisher)", "Heel Elevated Back Squat", "Unilateral Leg Extension (finisher)"] },
      { day: 4, name: "Day 4 — Chest & Side Delts", muscleGroups: ["chest", "shoulders"], exercises: ["Incline Bench Press", "Bent-Over Cable Chest Fly", "Standing Cable Horizontal Fly", "Machine Lateral Raises", "DB Side Delt Raises"] },
      { day: 5, name: "Day 5 — Back, Rear Delts & Calves", muscleGroups: ["back", "shoulders", "calves"], exercises: ["Seated Cable Row (shoulder-width grip)", "One-arm Straight Arm Lat Pulldown", "Wide Grip Seated Cable Row", "Single-arm Lat Pulldown", "Shoulder-width Cable Row (finisher)", "Lying Face Pull", "Seated Calf Raises"] },
      { day: 6, name: "Day 6 — Triceps & Biceps", muscleGroups: ["triceps", "biceps"], exercises: ["Cross Body Cable Tricep Extension", "Single-arm Overhead Triceps Extension", "Machine Dips (finisher)", "Triceps Bar Press Down", "Alternating DB Biceps Curls", "Standard Barbell Curl (finisher)", "Single-arm Cable Curls", "Alternating DB Biceps Curls (finisher)"] },
      { day: 7, name: "Day 7 — Hamstrings & Quads", muscleGroups: ["hamstrings", "quads"], exercises: ["Seated Leg Curls", "Bilateral Leg Extension", "Single Leg Extension", "Heel Elevated Back Squat", "Leg Extension", "One-Legged Leg Extension (finisher)"] },
      { day: 8, name: "Day 8 — Chest & Side Delts", muscleGroups: ["chest", "shoulders"], exercises: ["Incline Bench Press", "Bent-Over Cable Chest Fly", "Standing Cable Horizontal Fly", "Bent-Over Parallel Cable Fly", "Machine Lateral Raises", "DB Side Delt Raises"] },
    ],
  },
  {
